  ...
  async function submitMovie(event) {
    ...
    try {
      ...
      Object.entries(movieForm).forEach(([field, value]) => {
        formData.append(field, typeof value === 'boolean' ? String(value) : value);
      });
      ...
      const response = editingMovieId
        ...
        : await axios.post('/api/admin/movies', formData, getAdminRequestConfig());
      resetMovieForm();
      await loadDashboard();
      showToast(
        'success',
    ...
    <div className="space-y-6">
        ...
        <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">
              Admin can add a movie directly, or open an existing card below to edit it in the same form.
            </p>
          </div>
        ...
        <form className="space-y-6" onSubmit={submitMovie}>
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={(event) => updateMovieForm('genre', event.target.value)}
                required
              />
            </div>
            ...
            <div className="space-y-1 xl:col-span-2">
              ...
              <input
                ...
                onChange={(event) => updateMovieForm('subtitle', event.target.value)}
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={(event) => updateMovieForm('date', event.target.value)}
                required
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={(event) => updateMovieForm('durationMinutes', event.target.value)}
                required
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={(event) => updateMovieForm('screenName', event.target.value)}
                required
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={(event) => updateMovieForm('currency', event.target.value.toUpperCase())}
                maxLength={3}
              />
            </div>
            ...
            <div className="space-y-1 xl:col-span-2">
              ...
              <input
                ...
                onChange={(event) => updateMovieForm('venue', event.target.value)}
                required
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={(event) => updateMovieForm('city', event.target.value)}
                required
              />
            </div>
            ...
            <div className="space-y-1 xl:col-span-2">
              ...
              <input
                ...
                onChange={(event) => updateMovieForm('tags', event.target.value)}
              />
            ...
            <div className="space-y-1 xl:col-span-2">
              ...
              <input
                ...
                type="file"
                accept="image/*"
                onChange={(event) => setMoviePosterFile(event.target.files?.[0] || null)}
              />
              <p className="text-xs text-slate-500 dark:text-slate-400">
                {moviePosterFile
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">
                Configure the screen section-by-section. Layout changes are blocked for screens that already have active or confirmed bookings.
              </p>
            </div>
                  ...
                  <div className="grid gap-3">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={(event) => updateMovieForm(section.nameField, event.target.value)}
                        required
                      />
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={(event) => updateMovieForm(section.rowsField, event.target.value)}
                        required
                      />
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={(event) => updateMovieForm(section.seatsField, event.target.value)}
                        required
                      />
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={(event) => updateMovieForm(section.priceField, event.target.value)}
                        required
                      />
                    </div>
                  </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 dark:border-slate-800 dark:bg-slate-950">
            <label className="flex items-center gap-3 text-sm font-medium text-slate-700 dark:text-slate-200">
              <input
                ...
                onChange={(event) => updateMovieForm('featured', event.target.checked)}
              />
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div className="mb-4">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">
            Open any movie in edit mode, review its current show details, or upload a fresh poster directly from the catalog.
          </p>
        </div>
                  ...
                  <div className="space-y-4 p-5">
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white px-4 py-4 text-sm dark:border-slate-800 dark:bg-slate-900">
                      <div className="space-y-2 text-slate-600 dark:text-slate-300">
                        <div>
                          <span className="font-semibold text-slate-900 dark:text-slate-100">Theater:</span>{' '}
                          {movie.venue}, {movie.city}
                        </div>
                        <div>
                          <span className="font-semibold text-slate-900 dark:text-slate-100">Screen:</span>{' '}
                          {movie.screen?.name || 'Default screen'}
                        </div>
                        <div>
                          <span className="font-semibold text-slate-900 dark:text-slate-100">Showtime:</span>{' '}
                          {formatShowDate(movie.date)}
                        </div>
                        <div>
                          <span className="font-semibold text-slate-900 dark:text-slate-100">Base price:</span>{' '}
                          {formatCurrency(movie.pricing?.min || 0, movie.currency)}
                        </div>
                      </div>
                    </div>
