      ...
      >
        <div className="relative flex" style={{ minHeight: "360px" }}>
          ...
          <div className="flex-1 p-8 text-white bg-gradient-to-br from-indigo-800 via-purple-800 to-indigo-900">
            ...
            {/* Event poster image on the main (blank) side */}
            {event?.posterUrl ? (
              <div className="absolute right-8 bottom-8 hidden lg:block">
                <img
                  src={event.posterUrl}
                  alt="Event poster"
                  className="w-48 h-28 object-cover rounded shadow-lg"
                />
              </div>
            ) : null}
            ...
            <div className="uppercase tracking-widest text-cyan-300 mb-6">
              {event?.location}
            </div>
          ...
          <div className="w-64 p-6 text-white bg-gradient-to-b from-indigo-900 to-blue-800 flex flex-col">
            {/* Vertical date/time */}
            <div
              className="text-cyan-300 text-base font-bold mb-5 tracking-widest"
              style={{
            ...
            <div className="bg-white/10 rounded-xl p-3 mb-4 text-center">
              ...
              {registration.qrCodeDataUrl && (
                <img
                  ...
                  alt="QR"
                  className="mx-auto w-36 h-36 rounded-md bg-white p-1"
                />
              )}
            </div>
